...
-- Creating indicators and tracking the scoring class and seasons when player are active. Then insert into player_scd
...
-- Efficient way to insert into player_scd compared to generating years and then incrementing the data
